...
//    @DisplayName("Save Role - Only letters validation")
//    void testCreateRoleOnlyLetters() throws Exception {
//        when(roleService.saveRole(any(Roles.class)))
//                .thenThrow(new IllegalArgumentException("Role name should contain only letters"));
//
//        mockMvc.perform(post("/api/roles/save")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content("{\"role\":\"Admin123\"}"))
...
//    void testUpdateRole() throws Exception {
//        Long roleId = 1L;
//        Roles updatedRole = new Roles(1, "Manager");
//        when(roleService.updateRole(eq(roleId), any(Roles.class))).thenReturn(updatedRole);
//
//        mockMvc.perform(put("/api/roles/{id}", roleId)
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content("{\"role\":\"Manager\"}"))
...
//    @Test
//    void shouldReturnListOfAllRoles() throws Exception {
//        List<Roles> roles = List.of(new Roles(1,"Admin"), new Roles(2,"User"));
